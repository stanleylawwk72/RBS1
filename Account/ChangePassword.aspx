<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="ChangePassword.aspx.cs" Inherits="ChangePassword" EnableEventValidation = "false" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainChangePassword">
    <h2>
        Change Password
    </h2>
    <p>
        ...
        <asp:ValidationSummary ID="CheckUserPasswordValidationSummary" runat="server" CssClass="failureNotification" 
         ...
         <div class="accountInfo">
                <fieldset class="changePassword">
                    ...
                    <p>
                        <asp:Label ID="lblWindowAuthID" runat="server">Windows Authentication User ID:</asp:Label><br/>
                        <asp:TextBox ID="txtWindowAuthID" runat="server" Enabled=false></asp:TextBox>
                    </p>
                    <p>
                        <asp:Label ID="lblLogin" runat="server">User ID:</asp:Label><br/> 
                        <asp:TextBox ID="txtLogin" runat="server" Enabled=false></asp:TextBox>
                    </p>
                    <p>
                        <asp:Label ID="CurrentPasswordLabel" runat="server" AssociatedControlID="CurrentPassword">Old Password:</asp:Label>
                        <asp:TextBox ID="CurrentPassword" runat="server" CssClass="passwordEntry" TextMode="Password"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="CurrentPasswordRequired" runat="server" ControlToValidate="CurrentPassword" CssClass="failureNotification" ErrorMessage="Password is required." ToolTip="Old Password is required.">*</asp:RequiredFieldValidator>
                    </p>
                    <p>
                ...
                <p class="submitButton">
                    <asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword" Text="Change Password"  OnClick="btnChangePwd_Click"  ValidationGroup="CheckUserPasswordValidationGroup" CssClass="button"/>
